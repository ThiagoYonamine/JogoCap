...
int iniciarJogo()
{
    ...
    /*imagem[11] = al_load_bitmap("delano.png");
    imagem[12] = al_load_bitmap("delano.png");
    imagem[13] = al_load_bitmap("delano.png");
    imagem[14] = al_load_bitmap("delano.png");
    imagem[15] = al_load_bitmap("delano.png");*/
